...
class file_fuzzer:
	...
	def check_accessv(self,dbg):
		...
		print "[*] Woot! Handing an access wiolation!"
		...
		shutil.copy("test.%s"%self.ext,"crash\\%d_orig.%s"%(self.iteration,self.ext))
...
def print_usage():
	print "[*]"
	print "[*] file_fuzzer.py -e <Executeable Path> -x <File Extension>"
	print "[*]"
